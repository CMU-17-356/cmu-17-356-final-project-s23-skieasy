...
class Profile(models.Model):
    ...
    neighborhood  = models.CharField(max_length=25, choices=NEIGHBORHOOD_CHOICES, default='Shadyside')
    ...
    userType  = models.CharField(max_length=10, choices=USER_CHOICES, default='Ski')
